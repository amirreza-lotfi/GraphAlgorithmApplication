package com.example.graphalgorithms.feature_node.presentation.screen_run_algorithm.screen_dfs_traversal
...
class DfsViewModel(val hiltViewModel: UndirectedGraphProvider):ViewModel(){
    ...
    private fun depthFirstTraversal(startNodeLabel: String) {
        ...
        val startingNode = GraphScreenViewModel.findNodeByLabel(startNodeLabel,nodeList)
        dfs(startingNode)
    }
